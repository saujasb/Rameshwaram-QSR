...
## Connections
- [[BusinessDayCard()]] - `contains` [EXTRACTED]
- [[BusinessDayExamples()]] - `contains` [EXTRACTED]
- [[CoverageCard()]] - `contains` [EXTRACTED]
- [[DATASET_LABELS]] - `imports` [EXTRACTED]
- [[HOURS]] - `contains` [EXTRACTED]
- [[MUTED]] - `contains` [EXTRACTED]
...
- [[useBusinessDaySettings()]] - `imports` [EXTRACTED]
- [[useDatasetCoverage()]] - `imports` [EXTRACTED]
- [[useSetBusinessDayStartHour()]] - `imports` [EXTRACTED]

## Source
**Full file:** `client/src/modules/settings/SettingsPage.tsx`
```tsx
