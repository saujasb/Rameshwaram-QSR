...
## Connections
- [[BASIS_LABEL]] - `contains` [EXTRACTED]
- [[BasisTag()]] - `contains` [EXTRACTED]
- [[IntelligencePage.tsx]] - `imports_from` [EXTRACTED]
- [[Metric]] - `imports` [EXTRACTED]
- [[MetricBasis]] - `imports` [EXTRACTED]
- [[MetricRow()]] - `contains` [EXTRACTED]
- [[MetricValue()]] - `contains` [EXTRACTED]
- [[TodaysIntelligencePanel()]] - `contains` [EXTRACTED]
- [[apiintelligence.ts]] - `imports_from` [EXTRACTED]
- [[businessDate.ts]] - `imports_from` [EXTRACTED]
- [[fmtInr()]] - `contains` [EXTRACTED]
- [[fmtPct()]] - `contains` [EXTRACTED]
- [[fmtQty()]] - `contains` [EXTRACTED]
...
## Source
**Full file:** `client/src/modules/intelligence/TodaysIntelligencePanel.tsx`
```tsx
import { Link } from "react-router-dom";
import type { Metric, MetricBasis } from "@shared/intelligence";
import { formatBusinessDateLong, formatHourBucket } from "@shared/businessDate";
import { useTodaysIntelligence } from "../../lib/api/intelligence";
import "./intelligence.css";

// THE RULE: a figure whose basis is "unavailable" (or whose value is null) is
// never rendered as a number, a zero or a bare dash. It says "Insufficient
// data" and explains why. Everything else carries a visible basis tag so a
// calculated figure is never mistaken for a measured one.

const BASIS_LABEL: Record<MetricBasis, string> = {
  observed: "observed",
...
/** Renders one server Metric, honouring its provenance. Never invents a number. */
