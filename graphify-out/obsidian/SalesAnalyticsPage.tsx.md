...
## Connections
- [[CHANNEL_COLOR]] - `contains` [EXTRACTED]
- [[DataFreshnessBadge()]] - `imports` [EXTRACTED]
- [[DataFreshnessBadge.tsx]] - `imports_from` [EXTRACTED]
- [[DivergingBar()]] - `imports` [EXTRACTED]
- [[DivergingBar.tsx]] - `imports_from` [EXTRACTED]
- [[Donut()]] - `imports` [EXTRACTED]
- [[Donut.tsx]] - `imports_from` [EXTRACTED]
- [[HBarChart()]] - `imports` [EXTRACTED]
- [[HBarChart.tsx]] - `imports_from` [EXTRACTED]
- [[LiveSalesSection()]] - `contains` [EXTRACTED]
- [[RangePreset]] - `contains` [EXTRACTED]
- [[SALES_CHANNEL_LABELS]] - `imports` [EXTRACTED]
- [[SEVERITY_COLOR]] - `contains` [EXTRACTED]
- [[SalesAnalyticsPage()]] - `contains` [EXTRACTED]
...
- [[computeRange()]] - `contains` [EXTRACTED]
...
- [[useLatestImportBatch()]] - `imports` [EXTRACTED]
- [[usePrioritizedActions()]] - `imports` [EXTRACTED]
- [[useSalesSummary()]] - `imports` [EXTRACTED]
- [[useSalesTargetWithEditor()]] - `imports` [EXTRACTED]

## Source
**Full file:** `client/src/modules/sales-analytics/SalesAnalyticsPage.tsx`
```tsx
