...
- [[KITCHEN_STATUSES]] - `contains` [EXTRACTED]
- [[KitchenPage()]] - `contains` [EXTRACTED]
- [[ManualOrderEntry]] - `imports` [EXTRACTED]
- [[NEXT_STATUS]] - `imports` [EXTRACTED]
...
- [[columns_10]] - `contains` [EXTRACTED]
- [[entities.ts]] - `imports_from` [EXTRACTED]
- [[formFields_9]] - `contains` [EXTRACTED]
- [[orderHooks]] - `imports` [EXTRACTED]
- [[orders.ts]] - `imports_from` [EXTRACTED]
- [[routes.tsx]] - `imports_from` [EXTRACTED]
- [[types.ts]] - `imports_from` [EXTRACTED]
- [[useKitchenQueue()]] - `contains` [EXTRACTED]

## Source
**Full file:** `client/src/modules/kitchen/KitchenPage.tsx`
```tsx
