...
- [[CATEGORY_OPTIONS_1]] - `imports` [EXTRACTED]
...
## Source
**Full file:** `client/src/modules/tasks/TasksPage.tsx`
```tsx
...
import type { BaseRecord, Task } from "@shared/entities";
import type { ColumnConfig } from "../../components/crud/types";
import { CATEGORY_OPTIONS, PRIORITY_OPTIONS, STATUS_OPTIONS, taskFormFields } from "./taskFields";
