...
## Connections
- [[NormalizedProviderOrder]] - `imports` [EXTRACTED]
...
- [[mapAddon()_1]] - `contains` [EXTRACTED]
- [[mapDiscount()_1]] - `contains` [EXTRACTED]
- [[mapItem()_1]] - `contains` [EXTRACTED]
- [[mapOrderFrom()_1]] - `contains` [EXTRACTED]
- [[mapOrderType()_1]] - `contains` [EXTRACTED]
- [[mapPartPayment()]] - `contains` [EXTRACTED]
- [[mapStatus()_1]] - `contains` [EXTRACTED]
- [[mapTax()_1]] - `contains` [EXTRACTED]
