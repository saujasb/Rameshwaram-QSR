...
## Connections
- [[AttentionAlert]] - `imports` [EXTRACTED]
- [[AttentionRequiredCard()]] - `imports` [EXTRACTED]
- [[AttentionRequiredCard.tsx]] - `imports_from` [EXTRACTED]
- [[BusinessDayTimeline()]] - `imports` [EXTRACTED]
...
- [[GroupHeading()]] - `contains` [EXTRACTED]
- [[KpiTile()]] - `contains` [EXTRACTED]
...
- [[maintenanceHooks]] - `imports` [EXTRACTED]
...
## Source
**Full file:** `client/src/modules/dashboard/DashboardPage.tsx`
```tsx
