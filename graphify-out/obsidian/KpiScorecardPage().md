---
source_file: "client/src/modules/sales-analytics/KpiScorecardPage.tsx"
type: "code"
...
## Connections
- [[KpiScorecardPage.tsx]] - `contains` [EXTRACTED]
- [[routes.tsx]] - `imports` [EXTRACTED]
- [[useAnalyticsSnapshot()]] - `calls` [EXTRACTED]

## Source
**From** `client/src/modules/sales-analytics/KpiScorecardPage.tsx` **(starting line 3):**
```tsx
