...
- [[SEVERITY_RANK]] - `contains` [EXTRACTED]
- [[analysis.ts]] - `imports_from` [EXTRACTED]
- [[buildEvidence()]] - `contains` [EXTRACTED]
...
- [[wastageSurges()]] - `contains` [EXTRACTED]

## Source
**Full file:** `server/src/entities/intelligence/anomalies.ts`
```typescript
