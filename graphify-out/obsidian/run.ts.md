...
## Connections
- [[SOP_TASKS]] - `contains` [EXTRACTED]
- [[analyticsSnapshot_1]] - `imports` [EXTRACTED]
- [[data.ts]] - `imports_from` [EXTRACTED]
- [[inventoryrepository.ts]] - `imports_from` [EXTRACTED]
- [[inventoryRepository]] - `imports` [EXTRACTED]
- [[seedInventory()]] - `contains` [EXTRACTED]
- [[seedTasks()]] - `contains` [EXTRACTED]
- [[seedWastage()]] - `contains` [EXTRACTED]
- [[taskRepository]] - `imports` [EXTRACTED]
- [[tasksrepository.ts]] - `imports_from` [EXTRACTED]
- [[wastagerepository.ts]] - `imports_from` [EXTRACTED]
- [[wastageRepository]] - `imports` [EXTRACTED]

## Source
**Full file:** `server/src/db/seed/run.ts`
```typescript
