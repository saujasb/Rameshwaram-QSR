...
- [[analyticsSnapshot_1]] - `contains` [EXTRACTED]
- [[run.ts]] - `imports_from` [EXTRACTED]
- [[shared-typesanalytics.ts]] - `imports_from` [EXTRACTED]

## Source
**Full file:** `server/src/entities/analytics/data.ts`
```typescript
import type { AnalyticsSnapshot } from "../../../../shared-types/analytics.js";

// Ported verbatim from the real one-day operations report
// (rameshwaram_playbook_2.html, Brookefield branch, 07-Aug-2026).
// This is genuine business data, not a fixture — do not add or invent rows.
