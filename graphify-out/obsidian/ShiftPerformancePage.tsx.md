...
## Connections
- [[SHIFTS]] - `contains` [EXTRACTED]
- [[Shift]] - `imports` [EXTRACTED]
- [[ShiftPerformancePage()]] - `contains` [EXTRACTED]
...
## Source
**Full file:** `client/src/modules/shift-performance/ShiftPerformancePage.tsx`
```tsx
